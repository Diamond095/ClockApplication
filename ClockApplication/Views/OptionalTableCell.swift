...
class OptionalTableCell: UITableViewCell {
    ...
    init(mode: Mode, mainLabel: String, placeholder: String? = nil, controllerOption: String? = nil){
    ...
    func configureViews(mode: Mode){
        ...
        mainLabel.bottomAnchor.constraint(equalTo: bottomAnchor, constant: 10).isActive = true
        switch mode {
        case .withController:
            arrow.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -15).isActive = true
            arrow.topAnchor.constraint(equalTo: mainLabel.topAnchor).isActive = true
            controllerLabel.trailingAnchor.constraint(equalTo: arrow.trailingAnchor, constant: -15).isActive = true
            controllerLabel.topAnchor.constraint(equalTo: mainLabel.topAnchor).isActive = true
        case .withSwitch:
            switchView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -15).isActive = true
            switchView.topAnchor.constraint(equalTo: mainLabel.topAnchor).isActive = true
        ...
        case .withTextField:
            ...
            textField.topAnchor.constraint(equalTo: mainLabel.topAnchor).isActive = true
        }
    }
